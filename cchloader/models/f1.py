...
class F1Schema(Schema):
    ...
    ao = CustomNumberField(position=5, allow_none=True)
    r1 = CustomNumberField(position=6, allow_none=True)
    r2 = CustomNumberField(position=7, allow_none=True)
    r3 = CustomNumberField(position=8, allow_none=True)
    r4 = CustomNumberField(position=9, allow_none=True)
